...
var log = logMethodsToEvents(exports.event);
...
exports.table = function(arr) {
  arr.forEach(function(item) {
    log.writetableln(exports.widths, ['', grunt.util._.pad(item[0], col1len), '', item[1]]);
  });
};
...
exports.header = function() {
  log.writeln('Grunt: The JavaScript Task Runner (v' + grunt.version + ')');
};
