...
// relative to the base dir or to parameter relative).
task.loadNpmTasks = function(name, relative) {
  loadTasksMessage('"' + name + '" local Npm module');
  var root =  typeof relative === 'undefined' ? path.resolve('node_modules') : path.resolve(relative, 'node_modules');
