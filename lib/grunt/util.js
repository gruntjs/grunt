...
// before exiting in Windows (Tested in Node.js ?????)
var exit = require('../util/exit').exit;
util.exit = function(exitCode) {
  // Attempt to exit.
  exit(exitCode);
  // No more tasks should run. Really.
  util.task.clearQueue();
};
