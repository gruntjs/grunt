...
exports.description = 'Create a jQuery plugin in CoffeeScript, including Jasmine unit tests.';
...
exports.template = function(grunt, init, done) {
  ...
  grunt.helper('prompt', {type: 'miniboilerplate'}, [
    ...
    grunt.helper('prompt_for', 'author_github_username'),
