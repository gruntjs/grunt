...
If your code is DOM-related, [QUnit unit tests](task_qunit.md) will be used, otherwise [Nodeunit unit tests](task_nodeunit.md) will be used. Where appropriate, predefined [jshint](task_jshint.md), [concat](task_concat.md) and [uglify](task_uglify.md) tasks are generated. Also, depending on the library used, JSHint globals may be predefined (just `jQuery` for now).
...
In addition, predefined [jshint](task_jshint.md), [concat](task_concat.md) and [uglify](task_uglify.md) tasks are generated.
