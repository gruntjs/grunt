  ...
  Task.prototype.start = function() {
    ...
    var nextTask = function() {
      ...
      var status = task.fn.call({
        ...
        // A way for a task to know if tasks it depends on have failed.
        failed: this.failed.bind(this),
        // A way for a task to know if tasks it depends on have succeeded.
        succeeded: this.succeeded.bind(this),
