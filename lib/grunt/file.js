...
exports.create = function(grunt) {
  ...
  file.event = new EventEmitter();
  var log = logMethodsToEvents(file.event);
  ...
  file.read = function(filepath, options) {
    if (!options) { options = {}; }
    var contents;
    log.verbose.write('Reading ' + filepath + '...');
    try {
  ...
  file.readJSON = function(filepath, options) {
    ...
    var result;
    log.verbose.write('Parsing ' + filepath + '...');
    try {
  ...
  file.write = function(filepath, contents, options) {
    ...
    log.verbose.write((nowrite ? 'Not actually writing ' : 'Writing ') + filepath + '...');
  ...
  file._copy = function(srcpath, destpath, options) {
    ...
    if (process) {
      log.verbose.write('Processing source...');
      try {
    ...
    if (contents === false) {
      log.verbose.writeln('Write aborted.');
    } else {
  ...
  file.delete = function(filepath, options) {
    ...
    log.verbose.write((nowrite ? 'Not actually deleting ' : 'Deleting ') + filepath + '...');
