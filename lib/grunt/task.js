...
// Add a task.
exports.addTask = function(name, info, fn) {
  // A reference to the task, if already defined.
  var prev = exports.tasks[name];
  // The new task.
  var task = exports.tasks[name] = {
    info: info,
    fn: fn
  };
  // If the task was already defined, make it accessible.
  if (prev) {
    task.super = prev;
  }
};
...
exports.task = function(name) {
  ...
  if (!fn) {
    ...
    fn.apply("SOMETHING", slice.call(arguments, 1));
  }
  // Make chainable!
  return this;
};
