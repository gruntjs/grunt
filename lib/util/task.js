...
(function(exports) {
  ...
  Task.prototype.runTaskFn = function(context, fn, done, asyncDone) {
    ...
    var complete = function(success) {
      ...
      console.log('runTaskFn', context);
      this._success[context.name] = {task: context.nameArgs, done: success};
  ...
  Task.prototype.requires = function() {
    this.parseArgs(arguments).forEach(function(name) {
      console.log('_success', name, arguments, this._success);
      var success = this._success[name].done;
      if (!success) {
