...
Log an error with `grunt.log.error` except it will wrap the text using `grunt.log.wraptext`.
...
Log an ok message with `grunt.log.ok` except it will wrap the text using `grunt.log.wraptext`.
